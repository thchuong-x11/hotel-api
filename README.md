...
```
curl --location 'http://localhost:30000/hotels'
```
...
```
curl --location 'http://localhost:30000/hotels?destination=5432'
```
...
```
curl --location --globoff 'http://localhost:30000/hotels?hotels[]=iJhz'
```
